    ...
    <section className="my-5 md:grid grid-cols-12 sm:my-28">
      ...
      <section className="mx-5 xl:mx-10 flex col-span-11">
        <div className="w-full mt-20 mb-10">
          ...
          <p className="text-2xl font-semibold my-2 dash">Software developer and Machine Learning Engineer</p>
          <p className="my-5">
          Hi, I am Rezuwan Hassan, a Software developer and Machine Learning Engineer from Dhaka, Bangladesh. I have developed many types of front-ends and full-stack applications. Most of the time, I work with MERN stack technologies.
          </p>
